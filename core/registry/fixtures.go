...
var FixtureMap = map[string]FixtureDefinition{
	...
	"createProjectWithCustomer": {Description: "creates new project", ImportRef: "billing/service"},
	...
	"fakeProject":   {Description: "Pushes the internal project to tns", ImportRef: "config-compiler/fixtures"},
	"injectProject": {Description: "Pass in a *projectSchema.Project to inject it into tns", ImportRef: "config-compiler/fixtures", BlockCLI: true},
	"compileFor": {
		Description: "pushes specific repos",
